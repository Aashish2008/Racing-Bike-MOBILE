...
ground = createSprite(350,350,windowWidth, windowHeight);
  ...
  //rockstar
  rockstar = createSprite(width/2-720,height/2-320,50,50);
  rockstar.addImage("rockstar",rockstarimg);
  rockstar.scale = 0.3;

  RESTART = createSprite(width/2-415, height/2+90,30,30);
  RESTART.addImage("restart",restartimg);
  RESTART.scale=0.6;
  RESTART.visible=false;

  GAMEOVER = createSprite(width/2-415, height/2-70,30,20);
...
textSize(30);
  textFont(20);
  fill ("yellow")
  text("SCORE: "+ score,width/2-640, height/2-310);
